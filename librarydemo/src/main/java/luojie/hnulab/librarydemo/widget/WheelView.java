...
import luojie.hnulab.librarydemo.entity.WheelItem;
import luojie.hnulab.librarydemo.utli.ConvertUtils;
...
public class WheelView extends View {
    ...
    public static final int TEXT_COLOR_LABEL = 0XFF0288CE;
    public static final int DIVIDER_COLOR = 0XFF83CDE6;
    public static final int DIVIDER_ALPHA = 220;
    public static final float DIVIDER_THICK = 1f;//px
    ...
    private int textColorLabel = TEXT_COLOR_LABEL;//选中项文字颜色
