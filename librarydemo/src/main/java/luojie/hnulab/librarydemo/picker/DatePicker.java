...
public class DatePicker extends DateTimePicker {
     ...
     * 设置范围：开始的年
     */
    public void setRangeStart(int startYear) {
        super.setDateRangeStart(startYear);
    }
     ...
     * 设置范围：结束的年月日
     */
    public void setRangeEnd(int endYear) {
        super.setDateRangeEnd(endYear);
    }
    ...
    public void setSelectedItem(int year) {
        super.setSelectedItem(year, 0, 0, 0);
    }
    ...
    public void setOnDatePickListener(final OnDatePickListener listener) {
        ...
        }else if (listener instanceof OnYearPickListener) {
            super.setOnDateTimePickListener(new OnYearTimePickListener() {
                @Override
                public void onDateTimePicked(String year) {
                    ((OnYearPickListener) listener).onDatePicked(year);
                }
            });
        }
    }
