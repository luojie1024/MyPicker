...
import luojie.hnulab.librarydemo.popup.ConfirmPopup;
...
public abstract class WheelPicker extends ConfirmPopup<View> {
    ...
    protected int textColorLabel= WheelView.TEXT_COLOR_LABEL;
     ...
     * 设置文字 标签颜色
     */
    public void setLabelTextColor(@ColorInt int textColorLabe,@ColorInt int textColorFocus, @ColorInt int textColorNormal) {
        this.textColorLabel = textColorLabe;
        this.textColorFocus = textColorFocus;
        this.textColorNormal = textColorNormal;
    ...
    protected TextView createLabelView() {
        ...
        labelView.setTextColor(textColorLabel);
